...
title: Ensor
description: >-
  automated secret redaction,  the missing link between secret detection and
  secret management. censor your code from secrets.
date: '2026-09-06T17:57:00Z'
draft: false
weight: 0
tags:
  - ensor
...
![YouTube video](https://img.youtube.com/vi/3d1xLYkeVsA/0.jpg)
...
# ensor live demo of censoring.

![asciicast](https://asciinema.org/a/1264776.svg)

## ensor convert

ensor can convert between any format of `env` files. dotenv, YAML, TOML, JSON interchangeably.
